...
{ 
  ...
  if(isset($_POST['updateprofile']))
  {
    ...
    $query->execute();
    $msg="Profil je uspesno promenjen";
  }
  ...
  <head>
    <meta charset="utf-8">
    <title>Auto-Plac | My Profile</title>
          ...
          <section class="user_profile inner_pages">
            <div class="container">
              <div class="user_profile_info gray-bg padding_4x4_40">
                <div class="upload_user_logo"> <img src="img/vehicleimages/avatar0.jpg" alt="image">
                </div>
                  ...
                  <div class="col-md-3 col-sm-3">
                    ...
                    <div class="col-md-6 col-sm-8">
                      <div class="profile_wrap">
                        <h5 class="uppercase underline">Podesavanja</h5>
                        <?php  
                        if($msg)
                        {
                          ?>
                        ...
                        <form  method="post">
                          ...
                          <div class="form-group">
                            <label class="control-label">Datum Rodjenja&nbsp;(dd/mm/yyyy)</label>
                          ...
                          <div class="form-group">
                            <label class="control-label">Tvoja adresa</label>
                          ...
                          <div class="form-group">
                            <button type="submit" name="updateprofile" class="btn btn-primary"  style="background-color: #49a3ff;"  >Sacuvaj Promene <span class="angle_arrow"><i class="fa fa-angle-right"  style="color: #49a3ff;"  aria-hidden="true"></i></span></button>
                          </div>
                        </form>
                      </div>
                    </div>
